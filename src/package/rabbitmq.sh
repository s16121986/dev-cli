...
function pkg::rabbitmq::is_installed {
  command -v "rabbitmq-server" >/dev/null 2>&1 && return 0 || return 1
}

function pkg::rabbitmq::install {
...
function pkg::rabbitmq::remove {
  sudo apt-get purge -y --auto-remove rabbitmq
}
